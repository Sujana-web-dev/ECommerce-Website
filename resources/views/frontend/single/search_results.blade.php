    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-12">
            <nav class="flex justify-center items-center space-x-2 mb-6" aria-label="Breadcrumb">
                ...
                <span class="text-primary-600 font-medium">Search Results</span>
            </nav>
            ...
            @if($query)
                <p class="text-xl text-gray-600 mb-2">
                    Showing results for: <span class="font-semibold text-primary-600">"{{ $query }}"</span>
                </p>
        ...
        @if($products->count() > 0)
            <!-- Products Grid with Books Page Design -->
                ...
                <div class="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-700 h-[450px] flex flex-col product-card transform hover:-translate-y-3 hover:scale-105" data-category="{{ $product->category ? $product->category->name : 'Uncategorized' }}" data-product="{{ $product->id }}">
                    ...
                    <div class="relative bg-white rounded-3xl h-full flex flex-col">
                        ...
                        <div class="relative overflow-hidden h-72 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 rounded-t-3xl">
                            @if($product->image)
                                <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 filter group-hover:brightness-110">
                            @else
        ...
        @else
            ...
            <div class="text-center py-20">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 max-w-4xl mx-auto">
                    <h3 class="text-xl font-semibold text-gray-900 mb-6">Try searching for:</h3>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="{{ route('products.search', ['query' => 'electronics']) }}" 
                           class="bg-white hover:bg-primary-50 hover:text-primary-600 text-gray-700 px-4 py-3 rounded-xl font-medium transition-all duration-300 border border-gray-200 hover:border-primary-200">
                            Electronics
                        </a>
                        <a href="{{ route('products.search', ['query' => 'fashion']) }}" 
                           class="bg-white hover:bg-primary-50 hover:text-primary-600 text-gray-700 px-4 py-3 rounded-xl font-medium transition-all duration-300 border border-gray-200 hover:border-primary-200">
                            Fashion
                        </a>
                        <a href="{{ route('products.search', ['query' => 'home']) }}" 
                           class="bg-white hover:bg-primary-50 hover:text-primary-600 text-gray-700 px-4 py-3 rounded-xl font-medium transition-all duration-300 border border-gray-200 hover:border-primary-200">
                            Home & Garden
                        </a>
                        <a href="{{ route('products.search', ['query' => 'sports']) }}" 
                           class="bg-white hover:bg-primary-50 hover:text-primary-600 text-gray-700 px-4 py-3 rounded-xl font-medium transition-all duration-300 border border-gray-200 hover:border-primary-200">
                            Sports
                        </a>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <a href="{{ route('all.products') }}" 
                           class="inline-flex items-center space-x-2 bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105">
...
<!-- Quick View Modal (you may need to include this from your existing modal) -->
