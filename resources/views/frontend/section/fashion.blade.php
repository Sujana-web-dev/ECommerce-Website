    ...
    <div class="relative z-20 py-16 px-6 text-center">
        <div class="container mx-auto">
            <div class="inline-flex items-center space-x-6 mb-8">
                ...
                <h1 class="text-7xl font-black text-white tracking-tight drop-shadow-2xl">Fashion</h1>
            </div>
            <p class="text-white/90 text-2xl max-w-4xl mx-auto font-light mb-8 drop-shadow-lg leading-relaxed">Discover premium fashion products with our curated collection</p>
        ...
        <div class="flex justify-center mb-16">
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-white/50">
                <div class="flex space-x-2">
                    @php
                    $categories = ['all' => 'All', 'Women' => 'Women', 'Men' => 'Men', 'Accessories' => 'Accessories', 'Footwear' => 'Footwear', 'Kids' => 'Kids'];
                    @endphp
