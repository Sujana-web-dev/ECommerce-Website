...
<section class=" relative overflow-hidden">
    ...
    <div class="relative z-20 py-16 px-6 text-center">
        <div class="container mx-auto">
            ...
            <p class="text-white/90 text-2xl max-w-4xl mx-auto font-light mb-8 drop-shadow-lg leading-relaxed">Discover premium electronics products with our curated collection</p>
        ...
        <div class="flex justify-center mb-16">
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-white/50">
                <div class="flex space-x-2">
                    @php
                    $categories = ['all' => 'All', 'Smartphones' => 'Smartphones', 'Laptops' => 'Laptops', 'Tablets' => 'Tablets', 'Accessories' => 'Accessories', 'Wearables' => 'Wearables'];
                    @endphp
                ...
                <div class="relative bg-white rounded-3xl h-full flex flex-col">
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between relative">
                        ...
                        <button onclick="addToCart('{{ $product->id }}')" class="relative w-full bg-gradient-to-r from-[#1D293D] to-[#2a3f57] text-white py-3 rounded-2xl font-bold text-lg hover:from-[#ec4642]  hover:to-[#c0392b] transition-all  ">
                            ...
                            <!-- Button Content -->
                            <span class="relative flex items-center justify-center space-x-3" onclick="addToCart({{ $product->id }})">
