    ...
    <div class="bg-gradient-to-r from-[#1D293D] to-gray-900 shadow-2xl">
        <div class="px-4 py-4">
            ...
            <div class="flex items-center text-sm text-gray-300 mb-3">
                ...
                <span class="text-white font-medium">Approved Orders</span>
            </div>
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-200">Manage approved orders ready for processing</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                    ...
                    <div class="text-xs text-gray-300">Approved Orders</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                    ...
                    <div class="text-xs text-gray-300">Today's Approvals</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="p-4 space-y-6">
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
            ...
            <div class="bg-gradient-to-r from-[#1D293D] to-gray-800 px-4 py-3">
                <div class="flex items-center justify-between">
                    <h3 class="text-base font-semibold text-white">Approved Orders List</h3>
                    <div class="text-xs text-gray-300">
                        <span>Showing {{ $orders->count() }} approved orders</span>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                    <thead class="bg-gradient-to-r from-blue-50 to-cyan-50">
                        <tr>
                            ...
                            <th class="px-3 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider w-28">
                                <div class="flex items-center gap-1">
                                    <i class="fas fa-check-circle text-[#1D293D] text-xs"></i>
                                    <span>Status</span>
                                </div>
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 transition-all duration-200 group">
                            <!-- Order ID -->
                            <td class="px-3 py-3 whitespace-nowrap w-20">
                                <div class="w-10 h-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-200">
                            ...
                            <td class="px-3 py-3 whitespace-nowrap w-48">
                                <div class="flex items-center space-x-2">
                                    <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shadow-md flex-shrink-0">
                                ...
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <div class="relative inline-block">
                                        <select onchange="updateOrderStatus('{{ $order->id }}', this.value)" 
                                                class="w-20 h-6 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-md text-xs border-0 focus:ring-2 focus:ring-blue-500 cursor-pointer">
            ...
            <div class="p-12 text-center">
                <div class="flex flex-col items-center justify-center">
                    <div class="w-24 h-24 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-full flex items-center justify-center mb-6 relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full opacity-20 animate-ping"></div>
                        <i class="fas fa-check-circle text-4xl text-transparent bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text relative z-10"></i>
                    </div>
                    <h3 class="text-xl font-bold text-transparent bg-gradient-to-r from-gray-600 to-gray-800 bg-clip-text mb-3">No Approved Orders</h3>
                    <p class="text-sm text-gray-500 mb-6 max-w-md">
                        No orders are currently approved. Approved orders will appear here when pending orders are approved.
                    </p>
                </div>
            </div>
            @endif
