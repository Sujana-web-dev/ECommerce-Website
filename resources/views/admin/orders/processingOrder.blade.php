...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-indigo-50">
    ...
    <div class="bg-gradient-to-r from-[#1D293D] to-gray-900 shadow-2xl">
        <div class="px-4 py-4">
            ...
            <div class="flex items-center text-sm text-gray-300 mb-3">
                ...
                <span class="text-white font-medium">Processing Orders</span>
            </div>
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-white mb-1">
                        🔄 Processing Orders ({{ $orders->count() }})
                    </h1>
                    <p class="text-sm text-gray-200">Manage orders currently being processed</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                    ...
                    <div class="text-xs text-gray-300">Processing Orders</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center border border-white/20">
                    ...
                    <div class="text-xs text-gray-300">Today's Processing</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
            ...
            <div class="bg-gradient-to-r from-[#1D293D] to-gray-800 px-4 py-3">
                <h2 class="text-lg font-medium text-white flex items-center gap-2">
                    <i class="fas fa-cogs text-indigo-300"></i>
            ...
            <div class="overflow-hidden">
                <div class="overflow-x-auto max-h-[600px]" style="scrollbar-width: thin; scrollbar-color: #6366f1 transparent;">
                    <table class="w-full table-fixed">
                        <thead class="bg-gradient-to-r from-indigo-50 to-blue-50 sticky top-0 z-10">
                            <tr>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="group hover:bg-indigo-50/30 transition-colors duration-200">
                                {{-- Order ID --}}
                                <td class="px-4 py-3">
                                    <div class="text-sm font-semibold text-indigo-700 bg-indigo-50 px-2 py-1 rounded-lg inline-block">
                                        #{{ $order->id }}
                                    </div>
                                </td>
                                ...
                                {{-- Status --}}
                                <td class="px-4 py-3">
                                    <span class="inline-flex items-center gap-1 bg-gradient-to-r from-indigo-100 to-blue-100 text-indigo-700 text-xs font-medium px-3 py-1 rounded-full border border-indigo-200 animate-pulse">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="relative">
                                            <select onchange="updateOrderStatus('{{ $order->id }}', this.value)" 
                                                    class="bg-indigo-500 hover:bg-indigo-600 text-white px-3 py-1 rounded-lg text-sm border-0 cursor-pointer transition-colors duration-200">
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No Processing Orders</h3>
                <p class="text-gray-500 mb-4">No orders are currently being processed.</p>
                <a href="{{ route('orders.pending') }}" class="inline-flex items-center gap-2 bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 rounded-xl font-medium transition-colors duration-200">
